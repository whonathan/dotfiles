...
alias aoru  'aor -Syu --ignore $(sudo pacman -Qqm)'
alias aorc  'aor --noconfirm -Sc'
alias aorcc 'aor --noconfirm -Scc'
alias aorr  'aor --noconfirm -Rns'

alias aur   'paru'
alias aurs  'aur --noconfirm -S'
alias aurul 'aur -Qua'
alias auru  'aur -Sua' 
